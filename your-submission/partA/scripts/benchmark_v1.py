...
Evaluates:
  ...
  - Denominators:
      ...
      - per whitespace word
      - per UTF-8 byte
      - per Unicode character / code point
...
def main():
    ...
    for tok_name, fn in tokenizers.items():
        ...
        print(f"{'lang':<6}{'words/s':>9}{'tok/sent':>11}{'ratio(sent)':>13}{'tok/word':>11}{'ratio(word)':>13}{'tok/byte':>10}{'ratio(byte)':>13}")
        print("-" * 88)
        for lang in languages:
            d = bench[lang]
            print(f"{lang:<6}{d['words_per_sent']:>9.1f}{d['tok_per_sent']:>11.1f}{d['ratio_per_sent']:>12.2f}x{d['tok_per_word']:>11.2f}{d['ratio_per_word']:>12.2f}x{d['tok_per_byte']:>10.3f}{d['ratio_per_byte']:>12.2f}x")
